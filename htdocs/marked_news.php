				...
				<div>
					...
					<ul>
							...
							<?php
									...
									$db_link=Connect_DB();
									$uname=$_SESSION['user'];
									$query="CREATE OR REPLACE VIEW $uname as SELECT * from marked_news where username='$uname'";
								...
								if(isset($_POST['search']))
									...
									$query="SELECT * FROM $uname,news where news.nid=$uname.nid AND news.type='$type'";
									
									}
									else{			
	
									$query="SELECT * FROM $uname,news where news.nid=$uname.nid";
									}
